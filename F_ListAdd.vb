Public Class F_ListAdd
    Private _AddingNewListName As Boolean
    Public Property AddingNewListName As Boolean
        Get
            Return _AddingNewListName
        End Get
        Set(ByVal value As Boolean)
            _AddingNewListName = value
        End Set
    End Property
    ...
    Private Sub F_ListAdd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Tb_Msg.MaxLength = 28 ' 84
        _RetMessage = "" '"Nothing"
        ...
        If _AddingNewListName = True Then
            '   Panel2.Visible = False

            Text = "Adding New List"

            Lbl_AddingEditing.Text = "Enter New List Name"
        ...
        Else
            ...
            Me.Text = "Editing List Name"
            Lbl_AddingEditing.Text = "Edit List Name"

            Tb_Msg.Text = Mid(Trim(_PassMessage), 1, 28) '84)
        ...
        'Tb_Msg.Text = Mid(Trim(Tb_Msg.Text), 1,28)' 84)
    ...
    End Sub
    Private Sub retText()
        _RetMessage = Trim(Mid(Trim(Tb_Msg.Text), 1, 28)) ' 84))
        '_ReturnPutOnTop = CheckBox1.Checked
