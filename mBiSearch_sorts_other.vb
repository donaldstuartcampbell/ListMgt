...
Module mBiSearch_sorts_other
    ...
    Sub test_BiSearch()
        ...
        Debug.Print(BiSearch_Int_GT(a, 29))
        Debug.Print(BiSearch_Int_GT(a, 30))
        Debug.Print(BiSearch_Int_GT(a, 54))
        Debug.Print(BiSearch_Int_GT(a, 55))
    ...
    Function BiSearch_Int_GTE(ByRef a() As Integer, ByVal Find As Integer, Optional ByVal base As Integer = 1, Optional ByVal HightestEqual As Boolean = False) As Integer 'GTE means GreaterThanOrEqualTo
        ...
        Return low
    End Function
    Function BiSearch_Long_GTE(ByRef a() As Long, ByVal Find As Long, Optional ByVal base As Long = 1, Optional ByVal HightestEqual As Boolean = False) As Long 'GTE means GreaterThanOrEqualTo
    ...
    End Sub
    Sub ShellSort(ByRef list() As Integer, ByRef NumofElements As Integer)
        Dim offset, limit As Integer
        Dim tmp As Integer
        Dim Switch As Boolean

        offset = NumofElements / 2
        Do While offset > 0
